...
*   [ケース 22：小紅書（シャオホンシュー）の表紙 (by @balconychy)](#cases-22)
...
<a id="cases-46"></a>
### ケース 46：ハッピーカプセル製作 (by [@ZHO_ZHO_ZHO](https://x.com/ZHO_ZHO_ZHO))

[ソースリンク](https://x.com/ZHO_ZHO_ZHO/status/1911724629460455896)

<img src="cases/46/example_happy_capsule.png" width="300" alt="ハッピーカプセル"><br>
<sub>Image © 2025 <a href="https://github.com/jamez-bondos">@jamez-bondos</a>, <a href="https://creativecommons.org/licenses/by/4.0/">CC BY 4.0</a> • Prompt by <a href="https://x.com/ZHO_ZHO_ZHO">@ZHO_ZHO_ZHO</a></sub>
...
```
タイトル（大文字）：即効幸せカプセル
スターバックスのグリーンと透明の二色からなる小さな錠剤、スターバックスのロゴが印刷されており、中にはたくさんのコーヒー豆が入っています
説明（小文字）：悲しい時や落ち込んだ時にお飲みください、1日3回、1回2錠
購入ボタン 錠剤と同じ色で、下に価格：$9、医師の指示に従ってご購入ください
```
...
<a id="cases-40"></a>
### ケース 40：日系2コマ漫画（少女大統領が赤面している） (by [@hellokaton](https://x.com/hellokaton))

[ソースリンク](https://x.com/hellokaton/status/1910900979194646959)

<img src="cases/40/example_two_panel_manga_president.png" width="300" alt="日系二コマ漫画：少女大統領が電話に出られなかったことに怒って関税を上げる"><br>
...
```
日系萌え系の二コマ漫画を作成してください。上下に配置し、テーマは「少女大統領の日常業務」です。

キャラクター設定: アップロードされた添付ファイルを日系萌え系カートゥンの女の子のスタイルに変換し、服装（スーツ）、髪型（明るい金髪）、顔の特徴など、元の画像のすべての詳細を保持してください。

1コマ目:
- 表情: 不満げで落ち込んだ表情、片手で頬杖をついている
- テキスト: 「どうしよう！彼が電話に出てくれないの！(；´д｀)」
- 背景: 暖色系のオフィス、背後にアメリカ国旗、机の上にはハンバーガーの山と赤いダイヤル式電話。キャラクターは画面左側、電話は右側に配置。

2コマ目:
- 表情: 歯ぎしりして激怒し、顔を赤らめている
- 動作: 机を強く叩き、ハンバーガーが跳ね上がる
- 吹き出し: 「ふん！関税を倍にしてやる！私を無視するなんて彼らの損よ！( `д´ )」
- 背景: 1コマ目と同じだが、散らかっている状態。

その他の指示:
- テキストはシンプルで可愛い手書き風フォントを使用し、全体的に可愛くて面白い雰囲気に。
- 構図は豊かで生き生きとしたものにし、テキスト表示のための十分なスペースを確保し、適切な余白を残してください。
- 画像比率は2:3。
- 全体的に鮮やかな色彩で、カートゥン風のスタイルを強調してください。
```


**参考画像が必要：** 参考用に人物の写真をアップロードする必要があります。
...
<a id="cases-38"></a>
### ケース 38：手描きのインフォグラフィックカード (by [@dotey](https://x.com/dotey))

[ソースリンク](https://x.com/dotey/status/1907870919852179850)

<img src="cases/38/example_hand_drawn_infographic.png" width="300" alt="手描きインフォグラフィックカード"><br>
<sub>Image © 2025 <a href="https://github.com/jamez-bondos">@jamez-bondos</a>, <a href="https://creativecommons.org/licenses/by/4.0/">CC BY 4.0</a> • Prompt by <a href="https://x.com/dotey">@dotey</a></sub>

**プロンプト**

```
手描きスタイルの情報グラフィックカードを作成してください。比率は9:16の縦型です。カードのテーマは明確で、背景は紙の質感を持つベージュまたはオフホワイト色で、全体のデザインは素朴で親しみやすい手描きの美しさを表現しています。

カードの上部には、赤と黒が交互になった、コントラストの鮮やかな大きな筆文字の草書体で題名を目立たせ、視覚的な焦点を引きつけます。テキストはすべて中国語の草書体を使用し、全体のレイアウトは2〜4つの明確なセクションに分かれ、各セクションは簡潔で洗練された中国語のフレーズで核心ポイントを表現します。フォントは草書体の流れるようなリズム感を保ちながら、読みやすさと芸術性を兼ね備えています。周囲に適度な余白を残します。

カードには、人物や象徴的なシンボルなど、シンプルで面白い手描きのイラストやアイコンを散りばめ、視覚的な魅力を高め、読者の思考と共感を引き出します。全体のレイアウトは視覚的なバランスに注意し、十分な空白スペースを確保して、画面をシンプルで明確に、読みやすく理解しやすいものにします。

「IPづくりは長期的な複利効果
毎日の更新を続ければ、必ず結果が出ます。なぜなら99%の人は続けられないからです！
```
...
<a id="cases-34"></a>
### ケース 34：手描きの情報グラフィックカード (by [@dotey](https://x.com/dotey))

[ソースリンク](https://x.com/dotey/status/1907903480678985784)

<img src="cases/34/example_hand_drawn_infographic_cognition.png" width="300" alt="手描きのインフォグラフィックカード"><br>
<sub>Image © 2025 <a href="https://github.com/jamez-bondos">@jamez-bondos</a>, <a href="https://creativecommons.org/licenses/by/4.0/">CC BY 4.0</a> • Prompt by <a href="https://x.com/dotey">@dotey</a></sub>
...
カードの上部には、赤と黒が交互になった、コントラストの鮮やかな大きな筆文字の草書体で題名を強調し、視覚的な焦点を引きつけます。テキストはすべて中国語の草書体を使用し、全体のレイアウトは2〜4つの明確なセクションに分かれ、各セクションは簡潔で洗練された中国語のフレーズで核心ポイントを表現します。フォントは草書体の流れるようなリズム感を保ちながら、読みやすさと芸術性を兼ね備えています。

カードには、人物や象徴的なシンボルなど、シンプルで面白い手描きのイラストやアイコンを散りばめ、視覚的な魅力を高め、読者の思考と共感を引き出します。
全体のレイアウトは視覚的なバランスに注意し、十分な余白を残して、画面をシンプルで明確に、読みやすく理解しやすいものにします。

<h1><span style="color:red">「認識」</span>が上限を決め
<span style="color:red">「サークル」</span>が機会を決める</h1>
- あなたは「認識」の外のお金を稼げず、
- 「サークル」の外の機会にも出会えない。
```
...
<a id="cases-22"></a>
### ケース 22：小紅書（シャオホンシュー）の表紙 (by [@balconychy](https://x.com/balconychy))

[ソースリンク](https://x.com/balconychy/status/1905507936526627078)

<img src="cases/22/example_notebook_promo.png" width="300" alt="小紅書（シャオホンシュー）の表紙"><br>
<sub>Image © 2025 <a href="https://github.com/jamez-bondos">@jamez-bondos</a>, <a href="https://creativecommons.org/licenses/by/4.0/">CC BY 4.0</a> • Prompt by <a href="https://x.com/balconychy">@balconychy</a></sub>

**プロンプト**

```
画像：小紅書（RED）のカバーを描いてください。
要件：
ユーザーをクリックさせるための十分な魅力があること；
フォントは目立つもので、個性的なフォントを選ぶこと；
文字サイズは重要度によって段階的に分け、文章の論理構造を表現すること；
タイトルは通常の文字の少なくとも2倍のサイズにすること；
テキストの段落間に余白を設けること。
強調したい文字だけに目立つ色を使ってユーザーの注意を引くこと；
背景には目を引くパターンを使用すること（紙、ノート、WeChatチャットウィンドウなど、いずれか一つを選択）
適切なアイコンや画像を使って視覚的な階層を増やすが、干渉を減らすこと。

コピー文：重大発表！ChatGPTがさらにパワーアップ！
マルチタスク処理能力が向上✨
プログラミング能力が強化💪
創造性が爆発的🎨
今すぐ試してみて！
...
<a id="cases-15"></a>
### ケース 15：風刺ポスター生成 (by [@ZHO_ZHO_ZHO](https://x.com/ZHO_ZHO_ZHO))

[ソースリンク](https://x.com/ZHO_ZHO_ZHO/status/1905287637084274742)

<img src="cases/15/example_gpt_involution_poster.png" width="300" alt="風刺ポスター生成"><br>
<sub>Image © 2025 <a href="https://github.com/jamez-bondos">@jamez-bondos</a>, <a href="https://creativecommons.org/licenses/by/4.0/">CC BY 4.0</a> • Prompt by <a href="https://x.com/ZHO_ZHO_ZHO">@ZHO_ZHO_ZHO</a></sub>

**プロンプト**

```
風刺ポスターを生成してください：GPT-4oが席巻中、もう画像AIはやめて、フードデリバリーの仕事をしよう
```
...
<a id="cases-3"></a>
### ケース 3：レトロな宣伝ポスター (by [@dotey](https://x.com/dotey))

[ソースリンク](https://x.com/dotey/status/1905251524248248650)

<img src="cases/3/example_vintage_poster.png" width="300" alt="レトロな宣伝ポスター"><br>
<sub>Image © 2025 <a href="https://github.com/jamez-bondos">@jamez-bondos</a>, <a href="https://creativecommons.org/licenses/by/4.0/">CC BY 4.0</a> • Prompt by <a href="https://x.com/dotey">@dotey</a></sub>

**プロンプト**

```
レトロな宣伝ポスタースタイル、中国語のテキストを強調し、背景は赤と黄色の放射状パターン。ポスターの中央には美しい若い女性が、精巧なレトロスタイルで描かれ、微笑みを浮かべ、優雅で親しみやすい雰囲気を持っています。テーマはGPTの最新AIイラストサービスの広告で、「衝撃価格9.9/枚」、「あらゆるシーン、画像融合、部分的な再描画に対応」、「1枚につき3回の修正可能」、「AI直接出力効果、修正不要」を強調し、下部に目立つように「ご興味のある方は右下の"申し込む"をクリック」と表示。右下には指でボタンをクリックする動作が描かれ、左下にはOpenAIのロゴが表示されています。
```
